...
exports.SQL_PUESTO = {
    ...
    HOW_MANY: "SELECT COUNT(*) as cantidad \
        FROM puestos \
        WHERE cod_puesto = $1",
    ADD: "INSERT INTO puestos (cod_puesto, cod_parqueadero, cod_tipo_vehiculo, detalle_puesto) \
        VALUES($1, $2, $3, $4) \
