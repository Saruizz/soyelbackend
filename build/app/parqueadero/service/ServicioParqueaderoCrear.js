    ...
    static grabarParqueadero(obj, res) {
        return __awaiter(this, void 0, void 0, function* () {
            yield dbConnection_1.default
                ...
                let caso = 1;
                let objGrabado;
                const parqueaderos = yield consulta.one(sql_parqueadero_1.SQL_PARQUEADERO.HOW_MANY, [obj.nombreParqueadero]);
                if (parqueaderos.cantidad == 0) {
                    caso = 2;
                    objGrabado = yield consulta.one(sql_parqueadero_1.SQL_PARQUEADERO.ADD, [obj.codUbicacion, obj.nombreParqueadero, obj.dirParqueadero, obj.telParqueadero]);
                }
