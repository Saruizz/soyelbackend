    ...
    static actualizarParqueadero(objParqueadero, res) {
        return __awaiter(this, void 0, void 0, function* () {
            yield dbConnection_1.default
                ...
                let caso = 1;
                let objActualizado;
                const roles = yield consulta.one(sql_parqueadero_1.SQL_PARQUEADERO.HOW_MANY, [objParqueadero.nombreParqueadero]);
                if (roles.cantidad == 0) {
                    caso = 2;
                    objActualizado = yield consulta.result(sql_parqueadero_1.SQL_PARQUEADERO.UPDATE, [
