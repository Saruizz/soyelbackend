...
class ServicioDiarioActualizar {
    static actualizarServicioDiario(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const servicioActualizado = yield dbConnection_1.default.one(sql_servicio_diario_1.SQL_SERVICIO_DIARIO.UPDATE, [
                    codServicioDiario,
                    codParqueadero,
                    codVehiculo,
                    codPuesto,
                ...
                const servicioDiario = new ServicioDiario_1.default(servicioActualizado.codserviciodiario, servicioActualizado.codparqueadero, servicioActualizado.codvehiculo, servicioActualizado.codpuesto, servicioActualizado.fechainicioserviciodiario, servicioActualizado.fechafinserviciodiario, servicioActualizado.valorserviciodiario);
                res.status(200).json({
...
exports.default = ServicioDiarioActualizar;
