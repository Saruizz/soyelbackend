...
exports.SQL_TURNO = {
    ...
    DELETE: "DELETE FROM turnos WHERE cod_turno = $1 RETURNING *",
    UPDATE: "UPDATE turnos SET cod_parqueadero = $1, descripcion_turno = $2, fecha_turno = $3, \
