...
const ControladorTurnoActualizar_1 = __importDefault(require("../../turno/controller/ControladorTurnoActualizar"));
...
class RutaParqueadero {
    constructor() {
        ...
        this.rutaParqueaderoApi.put("/update", ControladorTurnoActualizar_1.default.llamarActualizar);
    }
}
