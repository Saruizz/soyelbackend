...
class ServicioUbicacionCrear {
    static grabarUbicacion(obj, res) {
        return __awaiter(this, void 0, void 0, function* () {
            yield dbConnection_1.default
                .task((consulta) => __awaiter(this, void 0, void 0, function* () {
                let caso = 1;
                let objGrabado;
                const parqueaderos = yield consulta.one(sql_ubicacion_1.SQL_UBICACION.HOW_MANY, [obj.nombreUbicacion]);
                if (parqueaderos.cantidad == 0) {
                    caso = 2;
                    objGrabado = yield consulta.one(sql_ubicacion_1.SQL_UBICACION.ADD, [obj.codPadreUbicacion, obj.codExternoUbicacion, obj.nombreUbicacion]);
                }
