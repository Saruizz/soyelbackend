    ...
    static borrar(obj, res) {
        return __awaiter(this, void 0, void 0, function* () {
            yield dbConnection_1.default
                ...
                let caso = 1;
                let objBorrado;
                const parqueos = yield consulta.one(sql_ubicacion_1.SQL_PARQUEADERO.HOW_MANY_COD, [obj.codParqueadero]);
                const turnos = yield consulta.one(sql_ubicacion_1.SQL_PARQUEADERO.HOW_MANY_TURNOS, [obj.codParqueadero]);
                if (turnos.cantidad == 0 && parqueos.cantidad > 0) {
                    caso = 2;
                    objBorrado = yield consulta.result(sql_ubicacion_1.SQL_PARQUEADERO.DELETE, [obj.codParqueadero]);
                }
                else {
