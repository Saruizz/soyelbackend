    ...
    static create(obj, res) {
        return __awaiter(this, void 0, void 0, function* () {
            yield dbConnection_1.default.task((task) => __awaiter(this, void 0, void 0, function* () {
                const result = yield task.none(sql_RelUserFunctionality_1.sqlRelUserFunctionality.create, [obj.codUsuario, obj.codFuncionalidad]);
                return { result };
            })).then(({ result }) => {
                res.status(200).json({
...
exports.default = ServiceCreateRelUserFunctionality;
